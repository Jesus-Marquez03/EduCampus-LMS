...
Un mensaje de commit debe ser breve, claro y descriptivo. Debe explicar
qué se hizo y, cuando sea necesario, por qué se hizo.
...
Lee el código línea por línea, verifica el propósito del cambio
y deja comentarios específicos y constructivos.